...
isMobile.any() ? document.documentElement.classList.add("touch") : document.documentElement.classList.add("no-touch");
...
const particlescounter = document.getElementById("particles-js");
...
if(document.getElementById( 'canvasTree' )) {
